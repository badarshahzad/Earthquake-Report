...
//                Log.i(TAG, "doInBackground: response "+jsonResponse);
                ...
                earthQuakesList = new ParseUSGSJsonUtils().parseJsonIntoData(earthQuakesList, jsonResponse, context,false);
...
//                    Log.i(TAG, "doInBackground: may be filter trouble");
                ...
                Log.i(TAG, "doInBackground: "+Double.valueOf(newEarthquake.getMagnitude()));

                if(Double.valueOf(newEarthquake.getMagnitude()) >= 3) {
//                    Log.i(TAG, "doInBackground: Zindaaaaaaaaaaa Baaaaaaaaaaad");
