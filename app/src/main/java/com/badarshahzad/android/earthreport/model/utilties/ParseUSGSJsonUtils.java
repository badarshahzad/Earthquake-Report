...
public class ParseUSGSJsonUtils {
    ...
    public List<EarthQuakes> parseJsonIntoData(List<EarthQuakes> earthQuakesArrayList, String jasonStr, Context context, boolean isFiltered) {
...
//                    Log.i(TAG, "package name: "+context.getPackageName());
                    ...
                    String filterMag = sharedPref.getString("key_filter_magnitude", "3");
                    ...
                    if (isFiltered) {
                        ...
                        if (place != null && mag != null && filterMag != null) {
                            ...
                            Log.i(TAG, "value1: "+filterMag);
                            Log.i(TAG, "value2: "+mag);
                            if(!mag.equals("null")) {
                        ...
                        //filter will not apply for the home screen today earthquakes
                        if (place != null && mag != null && filterMag != null) {
                            if (!mag.equals("null")) {
